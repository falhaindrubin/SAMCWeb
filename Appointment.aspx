...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$("[id$=imgbtnDeliveryDate]").click(function () {
            //    var POStatus;
            //    POStatus = $(this).closest('tr').find("[id*=lblPOStatus]").text();
            //    if (POStatus == "CANCELLED") {
            //        alert("This PO has been cancelled.");
            //        return false;
            //    }
            //    if (POStatus == "REJECTED") {
            //        alert("This PO has been rejected.");
            //        return false;
            //    }
            //    if (POStatus == "CHECK STATUS") {
            //        alert("This PO has not been verified.");
            //        return false;
            //    }
            //});
               ...
               <legend>Search Customer</legend>
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" ID="BtnSearchCustomer" Width="150" Text="Search Customer" OnClick="SearchCustomer" CssClass="btn btn-sm btn-primary"/>
                            <asp:Button runat="server" ID="BtnClearSearch" Width="150" Text="Clear" OnClick="ClearSearchCustomer" CssClass="btn btn-sm btn-default" />
                        </td>
                    </tr>
                </table>
            </fieldset>
    ...
    <div id="DivSearchResult" runat="server">
        <div class="entryblock">
            <fieldset>
                ...
                <table border="0" id="TblSearchResult" runat="server">
                    <tr>
